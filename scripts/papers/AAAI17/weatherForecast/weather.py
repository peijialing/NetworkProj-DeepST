...
from deepst.datasets import weather_load_data
...
map_height, map_width = 10, 36  # grid size
...
def main():
    # load data
    print("loading data...")
    X_train, Y_train, X_test, Y_test, external_dim = weather_load_data.load_data_weather(
        T=T, nb_flow=nb_flow, len_closeness=len_closeness, len_period=len_period, len_trend=len_trend, len_test=len_test,
        preprocess_name='preprocessing.pkl', meta_data=False,external_dim=8)
